package org.ncu.employee_app.config;
...
@Configuration
@ComponentScan(basePackages="org.ncu.employee-app")
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter{
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/employee");   //change database name if required
